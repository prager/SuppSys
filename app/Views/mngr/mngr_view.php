...
<div id="heading-breadcrumbs">
  <div class="container">
    <div class="row d-flex align-items-center flex-wrap">
      <div class="col-md-9">
        <h1 class="h3">Welcome to SuppSys Supply Management System</h3>
      </div>
      <div class="col-md-3">
        <ul class="breadcrumb d-flex justify-content-end">
          <li class="breadcrumb-item"><?php //echo anchor('test', 'Testing Page'); ?></li>
        </ul>
      </div>
    </div>
  </div>
                      ...
                      <ul class="nav nav-pills flex-column">
                        <li class="nav-item"><?php echo anchor('download-gear', 'Download Gear', 'class="nav-link"'); ?></li>
                          <li class="nav-item"><?php echo anchor('gearsets', 'Gearsets', 'class="nav-link"'); ?></li>
                            <li class="nav-item"><?php echo anchor('add-gear', 'Add Gear', 'class="nav-link"'); ?></li>
